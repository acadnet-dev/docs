...
The problems are formulated as real life scenarios, where a code is given that should have a certain behavior. Guess what, it doesn't. The students have to find bugs in the code and fix them.
